...
const Profile = () => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      // Fetch donor profile — optional, don't crash if missing
      try {
        ...
        // Donor profile missing is OK — user might not have set it up
        console.log('No donor profile found:', donorErr.message);
      }
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg
                           px-4 py-2.5 bg-gray-50 text-gray-400
                           cursor-not-allowed"
              />
            </div>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-xl border-2 font-medium
                                text-sm transition
                      ${personalForm.sex === value
      ...
      {activeTab === 'health' && (
        <div className="bg-white rounded-2xl shadow p-6">
          ...
          <p className="text-xs text-gray-400 mb-5">
            Keep this updated so we can match you accurately.
          </p>
          <form onSubmit={handleSaveHealth} className="space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-lg
                           px-4 py-2.5 bg-white focus:outline-none"
              >
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="block text-sm font-medium
                                  text-gray-600 mb-1">Age</label>
                <input type="number" value={healthForm.age}
                  min="18" max="65"
                  onChange={e => setHealthForm({
              ...
              <div className="flex-1">
                <label className="block text-sm font-medium
                                  text-gray-600 mb-1">Weight (kg)</label>
